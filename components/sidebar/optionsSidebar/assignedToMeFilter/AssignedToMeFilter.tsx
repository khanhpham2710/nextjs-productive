...
function AssignedToMeFilter({ userWorkspaces }: Props) {
  ...
  const handleRadioChange = (value: "all" | "tasks" | "mind-maps") => {
    ...
    link = workspaceFilterParam
      ? `/dashboard/assigned-to-me?workspace=${workspaceFilterParam}&type=${value}`
      : `/dashboard/assigned-to-me?workspace=all&type=${value}`;
