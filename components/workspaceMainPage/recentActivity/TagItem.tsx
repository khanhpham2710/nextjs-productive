...
export default function TagItem({ tag: { color, name } }: Props) {
    const tagColor = useMemo(() => {
      ...
      return (
        <div className="w-fit flex gap-2 items-center px-2.5 py-1 h-fit text-xs rounded-lg border border-input bg-background">
