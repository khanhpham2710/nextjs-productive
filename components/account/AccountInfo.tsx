...
import { accountInfoSettingsSchema, AccountInfoSettingsSchema } from "@/schema/accountInfoSettingSchema";
...
function AccountInfo({
    ...
    const { mutate: editProfile, isPending } = useMutation({
      ...
      onSuccess: async (res: AccountInfoSettingsSchema) => {
        if (res.language !== lang) onSelectChange(res.language as "vi" | "en");
        await update();
        router.refresh();
      },
        ...
        <CardContent>
          ...
          <Form {...form}>
            ...
            >
              ...
              <Button disabled={isPending} className="text-white dark:text-black" type="submit">
                {isPending ? (
