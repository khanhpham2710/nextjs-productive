      ...
      form.reset({
        ...
        type:
          (clickedEdge?.type as
            | "customBezier"
            | "customStraight"
            | "customStepSharp") ?? "customBezier",
        animated: clickedEdge?.animated ?? false,
        color:
          (clickedEdge?.data?.color as keyof typeof EdgeColor) ??
          EdgeColor.DEFAULT,
      });
    }
            ...
            <div className="space-y-2 sm:space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                  ...
                  />
                  <div className="leading-none" onClick={()=>setReverse((prev)=>(!prev))}>
                    <FormLabel>{t("FORM.REVERVE.LABEL")}</FormLabel>
                  </div>
                </div>
              </div>
            </div>
